...
t.add("security.login.remember_me", "Zapami\u0119taj mnie", "FOSUserBundle", "pl");
...
t.add("registration.check_email", "Na adres %email% wys\u0142ano wiadomo\u015b\u0107 e-mail z linkiem. Kliknij go, aby aktywowa\u0107 Twoje konto.", "FOSUserBundle", "pl");
t.add("registration.confirmed", "Gratulacje %username%, Twoje konto zosta\u0142o aktywowane.", "FOSUserBundle", "pl");
...
t.add("registration.flash.user_created", "Twoje konto zosta\u0142o utworzone", "FOSUserBundle", "pl");
t.add("registration.email.subject", "Cze\u015b\u0107 %username%!", "FOSUserBundle", "pl");
