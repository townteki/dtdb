...
namespace Dtdb\UserBundle\Entity;
...
class User extends BaseUser
{
     ...
     * Remove following
     *
     * @param \Dtdb\UserBundle\Entity\User $following
     */
    public function removeFollowing(\Dtdb\UserBundle\Entity\User $following)
    {
     ...
     * Remove followers
     *
     * @param \Dtdb\UserBundle\Entity\User $followers
     */
    public function removeFollower(\Dtdb\UserBundle\Entity\User $followers)
    {
