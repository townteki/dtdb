...
use Dtdb\CardsBundle\Entity\Suit;
use Dtdb\CardsBundle\Form\SuitType;
...
class SuitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DtdbCardsBundle:Suit')->findAll();

        return $this->render('DtdbCardsBundle:Suit:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DtdbCardsBundle:Suit:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DtdbCardsBundle:Suit')->find($id);
        ...
        return $this->render('DtdbCardsBundle:Suit:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DtdbCardsBundle:Suit:edit.html.twig', array(
            'entity'      => $entity,
