...
use Dtdb\CardsBundle\Entity\Type;
use Dtdb\CardsBundle\Form\TypeType;
...
class TypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DtdbCardsBundle:Type')->findAll();

        return $this->render('DtdbCardsBundle:Type:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DtdbCardsBundle:Type:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DtdbCardsBundle:Type')->find($id);
        ...
        return $this->render('DtdbCardsBundle:Type:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DtdbCardsBundle:Type:edit.html.twig', array(
            'entity'      => $entity,
