...
use Dtdb\CardsBundle\Form\PackType;
...
class PackController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DtdbCardsBundle:Pack')->findAll();

        return $this->render('DtdbCardsBundle:Pack:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DtdbCardsBundle:Pack:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DtdbCardsBundle:Pack')->find($id);
        ...
        return $this->render('DtdbCardsBundle:Pack:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DtdbCardsBundle:Pack:edit.html.twig', array(
            'entity'      => $entity,
