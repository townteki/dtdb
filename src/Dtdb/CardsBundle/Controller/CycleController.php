...
use Dtdb\CardsBundle\Form\CycleType;
...
class CycleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DtdbCardsBundle:Cycle')->findAll();

        return $this->render('DtdbCardsBundle:Cycle:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DtdbCardsBundle:Cycle:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DtdbCardsBundle:Cycle')->find($id);
        ...
        return $this->render('DtdbCardsBundle:Cycle:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DtdbCardsBundle:Cycle:edit.html.twig', array(
            'entity'      => $entity,
