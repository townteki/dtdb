...
class Card
{
    ...
    /**
     * @var \Dtdb\CardsBundle\Entity\Type
     */
    private $type;

    /**
     * @var \Dtdb\CardsBundle\Entity\Shooter
     */
    private $shooter;
     ...
     * Set pack
     *
     * @param \Dtdb\CardsBundle\Entity\Pack $pack
     * @return Card
     */
    public function setPack(\Dtdb\CardsBundle\Entity\Pack $pack = null)
    {
        $this->pack = $pack;
     ...
     * Set type
     *
     * @param \Dtdb\CardsBundle\Entity\Type $type
     * @return Card
     */
    public function setType(\Dtdb\CardsBundle\Entity\Type $type = null)
    {
        $this->type = $type;
     ...
     * Get type
     *
     * @return \Dtdb\CardsBundle\Entity\Type
     */
     ...
     * Set shooter
     *
     * @param \Dtdb\CardsBundle\Entity\Shooter $shooter
     * @return Card
     */
    public function setShooter(\Dtdb\CardsBundle\Entity\Shooter $shooter = null)
    {
     ...
     * Get shooter
     *
     * @return \Dtdb\CardsBundle\Entity\Shooter
     */
     ...
     * @return Card
     */
    public function setGang(\Dtdb\CardsBundle\Entity\Gang $gang = null)
    {
        $this->gang = $gang;
