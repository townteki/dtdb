...
use Dtdb\BuilderBundle\Entity\Type;
use Dtdb\BuilderBundle\Form\TypeType;
...
class TypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DtdbBuilderBundle:Type')->findAll();

        return $this->render('DtdbBuilderBundle:Type:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DtdbBuilderBundle:Type:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DtdbBuilderBundle:Type')->find($id);
        ...
        return $this->render('DtdbBuilderBundle:Type:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DtdbBuilderBundle:Type:edit.html.twig', array(
            'entity'      => $entity,
