...
use Dtdb\BuilderBundle\Form\PackType;
...
class PackController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DtdbBuilderBundle:Pack')->findAll();

        return $this->render('DtdbBuilderBundle:Pack:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DtdbBuilderBundle:Pack:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DtdbBuilderBundle:Pack')->find($id);
        ...
        return $this->render('DtdbBuilderBundle:Pack:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DtdbBuilderBundle:Pack:edit.html.twig', array(
            'entity'      => $entity,
