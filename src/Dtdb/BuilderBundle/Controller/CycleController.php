...
use Dtdb\BuilderBundle\Form\CycleType;
...
class CycleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DtdbBuilderBundle:Cycle')->findAll();

        return $this->render('DtdbBuilderBundle:Cycle:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DtdbBuilderBundle:Cycle:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DtdbBuilderBundle:Cycle')->find($id);
        ...
        return $this->render('DtdbBuilderBundle:Cycle:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DtdbBuilderBundle:Cycle:edit.html.twig', array(
            'entity'      => $entity,
