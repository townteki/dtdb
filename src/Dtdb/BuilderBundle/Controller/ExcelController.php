...
class ExcelController extends Controller
{
    ...
    {
        return $this->render('DtdbBuilderBundle:Excel:form.html.twig');
    }
    ...
    public function uploadAction(Request $request)
    {
        ...
        $repo = $em->getRepository('Dtdb\BuilderBundle\Entity\Card');
        
        foreach($cards as $i => $card)
        {
            $cards[$i]['warning'] = TRUE;
            
            /* @var $dbcard \Dtdb\BuilderBundle\Entity\Card */
        ...
        return $this->render('DtdbBuilderBundle:Excel:confirm.html.twig', array(
            'locale' => $locale,
        	'cards' => $cards
        ));
    }
    ...
    public function confirmAction()
    {
        ...
        foreach($cards as $i => $card)
        {
            ...
            $card['pack'] = $em->getRepository('DtdbBuilderBundle:Pack')->findOneBy(array("name$loc" => $card['pack']));
            $card['type'] = $em->getRepository('DtdbBuilderBundle:Type')->findOneBy(array("name$loc" => $card['type']));
            $card['shooter'] = $em->getRepository('DtdbBuilderBundle:Shooter')->findOneBy(array("name$loc" => $card['shooter']));
            $card['gang'] = $em->getRepository('DtdbBuilderBundle:Gang')->findOneBy(array("name$loc" => $card['gang']));
