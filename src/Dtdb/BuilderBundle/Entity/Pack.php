...
class Pack
{
    ...
    /**
     * @var \Dtdb\BuilderBundle\Entity\Cycle
     */
    private $cycle;
     ...
     * Set cycle
     *
     * @param \Dtdb\BuilderBundle\Entity\Cycle $cycle
     * @return Pack
     */
    public function setCycle(\Dtdb\BuilderBundle\Entity\Cycle $cycle = null)
    {
        $this->cycle = $cycle;
     ...
     * Get cycle
     *
     * @return \Dtdb\BuilderBundle\Entity\Cycle 
     */
